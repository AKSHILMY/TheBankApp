...
INSERT INTO `centralized_account` VALUES ('222428',5000.00,'Child',0),('222430',46939.63,'Teen',0),('222432',81306.83,'Join',0),('222434',113438.18,'Senior',1),('222436',39230.36,'Adult',1),('222438',87178.56,'Adult',0),('222440',139723.22,'Adult',0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `on_centralized_account_update` AFTER UPDATE ON `centralized_account` FOR EACH ROW update customer set ISActive = "No" where NEW.Balance<=1000 and Account_NO=OLD.Account_No */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `on_centralized_account_update_Active` AFTER UPDATE ON `centralized_account` FOR EACH ROW update customer set ISActive = "Yes" where NEW.Balance>1000 and Account_NO=OLD.Account_No */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
CREATE TABLE `customer` (
  ...
  `ISActive` varchar(15) DEFAULT 'Yes',
...
-- Dump completed on 2022-07-15 16:12:31
